      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="text-align: center;">
            <h1 style="margin: 0;"><a href="#" style="color: #EABD4E; font-size: 24px; font-weight: 700; font-family: 'Lato', sans-serif;"> Experttrades </a></h1> 
          </td>
        </tr>
      </table>
    </td>
        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h4 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome to Experttrades , your Number 1 online trading platform.</h4>
              <span>
        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h4 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">You have successfully logged in to,<br/> <span style=" font-weight: 500; color:#EABD4E; margin-top:-10px; font-size: 20px;"> Experttrades </span></h4>
